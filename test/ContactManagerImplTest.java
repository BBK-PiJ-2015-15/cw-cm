...
public class ContactManagerImplTest {
  ...
  public void testGettingFutureMeetingList() {
    ...
    int firstMeetingId = contactManager.addFutureMeeting(contacts, date);
    ...
    int thirdMeetingId = contactManager.addFutureMeeting(contacts, futureDate);
  ...
  public void testGettingMeetingList() {
    ...
    int secondMeetingId = contactManager.addFutureMeeting(contacts, futureDate);
  ...
  private void assertPastMeetingEquals(
    Meeting pastMeeting, Calendar date, Set<Contact> contacts, String notes
  ) {
  ...
  private void assertFutureMeetingEquals(
    Meeting futureMeeting, int id, Calendar date, Set<Contact> contacts
  ) {
  ...
  private void assertFutureMeetingEquals(
    Meeting futureMeeting, Calendar date, Set<Contact> contacts
  ) {
    assertTrue(futureMeeting instanceof FutureMeeting);
  ...
  private void assertGetFutureMeetingListEquals(
    Contact contact, FutureMeeting... expectedFutureMeetings
  ) {
    List<Meeting> futureMeetings = contactManager.getFutureMeetingList(contact);
  ...
  private void assertGetPastMeetingListEquals(
    Contact contact, PastMeeting... expectedPastMeetings
  ) {
  ...
  private void assertGetMeetingListEquals(
    Calendar date, int... expectedMeetingsIds
  ) {
